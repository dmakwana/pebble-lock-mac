...
function onMessage(event) {
  ...
  if (typeof(msg.status) != "undefined") {
    if (msg.status.connected === false) {
      ...
      Pebble.showSimpleNotificationOnPebble('Lock Your Mac', msg.status.message);
...
Pebble.addEventListener("ready", function() {
  ...
  if (channel === "") {
    Pebble.showSimpleNotificationOnPebble('Lock Your Mac', "Please add channel in app settings.");
  }
  connectWebsocket();
});
